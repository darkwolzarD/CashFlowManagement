...
{
    public class BusinessLiabilityCreateViewModel: IValidatableObject
    {
    ...
    public class BusinessLiabilityUpdateViewModel : BusinessLiabilityCreateViewModel
    {

    }

    public class BusinessLiabilityViewModel
    {
        public int Id { get; set; }
        public string Source { get; set; }
