...
namespace CashFlowManagement.Constants
{
    public static class Constants
    {
        ...
        public enum INCOME_TYPE { SALARY_INCOME = 1, BUSINESS_INCOME = 2, BANK_DEPOSIT_INCOME = 3, REAL_ESTATE_INCOME = 4, STOCK_INCOME = 5, OTHER_ASSET_INCOME = 6 }
        public enum LIABILITY_TYPE { REAL_ESTATE = 1, CAR = 2, CREDIT_CARD = 3, BUSINESS = 4, STOCK = 5, OTHERS = 6, INSURANCE = 7, OTHER_ASSET = 8 }
